...
export function issueTypeLabel(value: string): string {
  ...
  const labels: Record<string, string> = {
    ...
    forbidden_translation: '禁用译法',
    fixed_term_missing: '固定译名未使用',
    project_hard_rule: '项目必须规则',
    invalid_project_rule: '项目规则配置无效',
    fixture_failure: 'QA 环境异常',
    row_order: '行序不一致',
    empty_translation: '译文为空',
    chinese_residue: '译文残留中文',
    protected_token_missing: '保护标记丢失',
